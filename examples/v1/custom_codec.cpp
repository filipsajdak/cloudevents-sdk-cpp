...
struct codec {
  ...
  static auto make_bool(bool v) -> value {
    return value{.tag = ce::v1::json::kind::boolean, .boolean = v};
  }
  static auto make_int(std::int64_t v) -> value {
    return value{.tag = ce::v1::json::kind::integer, .integer = v};
  }
  static auto make_double(double v) -> value {
    return value{.tag = ce::v1::json::kind::floating, .number = v};
  }
  static auto make_string(std::string_view v) -> value {
    return value{.tag = ce::v1::json::kind::string, .text = std::string{v}};
  }
  static auto make_array() -> value { return value{.tag = ce::v1::json::kind::array}; }
  static auto make_object() -> value { return value{.tag = ce::v1::json::kind::object}; }
  ...
  static auto kind_of(const value& v) -> ce::v1::json::kind { return v.tag; }
  static auto size_of(const value& v) -> std::size_t {
    return v.tag == ce::v1::json::kind::array ? v.elements.size() : v.members.size();
  }
  ...
  static auto as_bool(const value& v) -> ce::v1::result<bool> {
    if (v.tag != ce::v1::json::kind::boolean) {
      return ce::v1::fail(ce::v1::errc::type_mismatch, "not a boolean");
    }
    return v.boolean;
  }
  static auto as_int(const value& v) -> ce::v1::result<std::int64_t> {
    if (v.tag != ce::v1::json::kind::integer) {
      return ce::v1::fail(ce::v1::errc::type_mismatch, "not an integer");
    }
    return v.integer;
  }
  static auto as_double(const value& v) -> ce::v1::result<double> {
    if (v.tag == ce::v1::json::kind::integer) {
      return static_cast<double>(v.integer);
    }
    if (v.tag != ce::v1::json::kind::floating) {
      return ce::v1::fail(ce::v1::errc::type_mismatch, "not a number");
    }
    return v.number;
  }
  static auto as_string(const value& v) -> ce::v1::result<std::string_view> {
    if (v.tag != ce::v1::json::kind::string) {
      return ce::v1::fail(ce::v1::errc::type_mismatch, "not a string");
    }
  ...
  static auto parse(std::string_view text) -> ce::v1::result<value>;
};
...
int main() {
  ...
  // format templates.
  static_assert(ce::v1::json::json_codec<demo::codec>);

  using format = ce::v1::json_format<demo::codec>;
  ...
  subject.data = ce::v1::json_text{.raw = R"({"total":42})"};
