---
uid: SWR-JSON-0039
title: The v3 codec concept requires value equality and a copyable value
type: software
status: reviewed
priority: high
rationale: >
...
version: 1
---
The v3 `json_codec` concept shall require a codec to provide `equal(const value&, const value&) -> bool` and a copy-constructible `value` type.
