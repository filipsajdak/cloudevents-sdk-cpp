...
// and ce::v1::uri_ref, ce::v1::event and the extension structs have no operator<<.
...
const boost::ut::suite<"extensions-described-structs"> described_structs = [] {
  ...
  "all five extensions are described"_test = [] {
    static_assert(ce::v1::described<ce::v1::ext::tracing>);
    static_assert(ce::v1::described<ce::v1::ext::partitioning>);
    static_assert(ce::v1::described<ce::v1::ext::sampled_rate>);
    static_assert(ce::v1::described<ce::v1::ext::sequence>);
    static_assert(ce::v1::described<ce::v1::ext::dataref>);
    expect(true);
  };
  ...
  "the macro backend describes them"_test = [] {
    ...
    static_assert(ce::v1::backend_of<ce::v1::ext::tracing> == ce::v1::describe_backend::macro);
    static_assert(ce::v1::backend_of<ce::v1::ext::dataref> == ce::v1::describe_backend::macro);
    expect(true);
  };

  "the wire names are the ones the CloudEvents spec defines"_test = [] {
    constexpr auto tracing = ce::v1::field_names<ce::v1::ext::tracing>();
    static_assert(ce::v1::field_count<ce::v1::ext::tracing> == 2);
    expect(tracing[0] == "traceparent"sv);
    expect(tracing[1] == "tracestate"sv);

    constexpr auto partitioning = ce::v1::field_names<ce::v1::ext::partitioning>();
    static_assert(ce::v1::field_count<ce::v1::ext::partitioning> == 1);
    expect(partitioning[0] == "partitionkey"sv);

    constexpr auto rate = ce::v1::field_names<ce::v1::ext::sampled_rate>();
    static_assert(ce::v1::field_count<ce::v1::ext::sampled_rate> == 1);
    ...
    constexpr auto sequence = ce::v1::field_names<ce::v1::ext::sequence>();
    static_assert(ce::v1::field_count<ce::v1::ext::sequence> == 1);
    expect(sequence[0] == "sequence"sv);

    constexpr auto dataref = ce::v1::field_names<ce::v1::ext::dataref>();
    static_assert(ce::v1::field_count<ce::v1::ext::dataref> == 1);
  ...
  "every wire name is a legal extension attribute name"_test = [] {
    ...
    for (const auto names :
         {ce::v1::field_names<ce::v1::ext::tracing>()[0], ce::v1::field_names<ce::v1::ext::tracing>()[1]}) {
      expect(ce::v1::valid_attribute_name(names)) << names;
      expect(!ce::v1::reserved_name(names)) << names;
    }
    expect(ce::v1::valid_attribute_name(ce::v1::field_names<ce::v1::ext::partitioning>()[0]));
    expect(ce::v1::valid_attribute_name(ce::v1::field_names<ce::v1::ext::sampled_rate>()[0]));
    expect(ce::v1::valid_attribute_name(ce::v1::field_names<ce::v1::ext::sequence>()[0]));
    expect(ce::v1::valid_attribute_name(ce::v1::field_names<ce::v1::ext::dataref>()[0]));
  };

  "the declared types are the CloudEvents attribute types"_test = [] {
    static_assert(std::is_same_v<decltype(ce::v1::ext::tracing::traceparent), std::string>);
    static_assert(
        std::is_same_v<decltype(ce::v1::ext::tracing::tracestate), std::optional<std::string>>);
    static_assert(std::is_same_v<decltype(ce::v1::ext::partitioning::partitionkey), std::string>);
    // Integer, not a string: the spec says sampledrate is an Integer, and the
    // declared type is what get<> restores it to.
    static_assert(std::is_same_v<decltype(ce::v1::ext::sampled_rate::sampledrate), std::int32_t>);
    static_assert(std::is_same_v<decltype(ce::v1::ext::sequence::value), std::string>);
    // URI-reference, not a string, for the same reason.
    static_assert(std::is_same_v<decltype(ce::v1::ext::dataref::value), ce::v1::uri_ref>);
    expect(true);
  };

  "sampledrate carries the one constraint the type system cannot"_test = [] {
    expect(ce::v1::ext::sampled_rate{.sampledrate = 1}.validate().has_value());
    expect(ce::v1::ext::sampled_rate{.sampledrate = 30}.validate().has_value());
    for (const std::int32_t bad : {0, -1, -30}) {
      auto checked = ce::v1::ext::sampled_rate{.sampledrate = bad}.validate();
      expect(!checked.has_value()) << bad;
      if (!checked) {
        expect(checked.error().code == ce::v1::errc::invalid_attribute_value) << bad;
...
const boost::ut::suite<"extensions-get-set-roundtrip"> get_set_roundtrip = [] {
  ...
  "each extension reads back what it wrote"_test = [] {
    ...
    const ce::v1::ext::tracing tracing{.traceparent = "00-0af7-00f0-01", .tracestate = "vendor=1"};
    expect(subject.set(tracing).has_value());
    auto read_tracing = subject.get<ce::v1::ext::tracing>();
    expect(read_tracing.has_value());
    if (read_tracing) {
      expect(bool{*read_tracing == tracing});
    }

    const ce::v1::ext::partitioning partitioning{.partitionkey = "customer-42"};
    expect(subject.set(partitioning).has_value());
    auto read_partitioning = subject.get<ce::v1::ext::partitioning>();
    expect(read_partitioning.has_value());
    if (read_partitioning) {
      expect(bool{*read_partitioning == partitioning});
    }

    const ce::v1::ext::sampled_rate rate{.sampledrate = 30};
    expect(subject.set(rate).has_value());
    auto read_rate = subject.get<ce::v1::ext::sampled_rate>();
    expect(read_rate.has_value());
    if (read_rate) {
      expect(bool{*read_rate == rate});
    }

    const ce::v1::ext::sequence sequence{.value = "0000000042"};
    expect(subject.set(sequence).has_value());
    auto read_sequence = subject.get<ce::v1::ext::sequence>();
    expect(read_sequence.has_value());
    if (read_sequence) {
      expect(bool{*read_sequence == sequence});
    }

    const ce::v1::ext::dataref dataref{.value = ce::v1::uri_ref{"https://example.test/blob/1"}};
    expect(subject.set(dataref).has_value());
    auto read_dataref = subject.get<ce::v1::ext::dataref>();
    ...
    expect(subject.get<ce::v1::ext::tracing>().has_value());
  ...
  "set stores each field under its declared attribute type"_test = [] {
    ...
    ce::v1::event subject = minimal();
    expect(subject.set(ce::v1::ext::sampled_rate{.sampledrate = 30}).has_value());
    expect(subject.set(ce::v1::ext::dataref{.value = ce::v1::uri_ref{"/blob"}}).has_value());
    expect(subject.set(ce::v1::ext::partitioning{.partitionkey = "k"}).has_value());
    ...
    if (reference != nullptr) {
      expect(std::holds_alternative<ce::v1::uri_ref>(*reference));
  ...
  "an absent optional field is nullopt, not an error"_test = [] {
    ce::v1::event subject = minimal();
    expect(subject.set(ce::v1::ext::tracing{.traceparent = "00-a-b-01", .tracestate = {}}).has_value());
    expect(subject.extension("tracestate") == nullptr);

    auto read = subject.get<ce::v1::ext::tracing>();
  ...
  "a nullopt optional removes an attribute already present"_test = [] {
    ...
    ce::v1::event subject = minimal();
    expect(
        subject.set(ce::v1::ext::tracing{.traceparent = "00-a-b-01", .tracestate = "v=1"}).has_value());
    expect(subject.extension("tracestate") != nullptr);
  ...
  "an absent required field is an error naming the attribute"_test = [] {
    ...
    expect(!read.has_value());
    if (!read) {
      expect(read.error().code == ce::v1::errc::missing_required_attribute);
    ...
    expect(
        subject.set_extension("tracestate", ce::v1::attribute_value{std::string{"v=1"}}).has_value());
    auto partial = subject.get<ce::v1::ext::tracing>();
    expect(!partial.has_value());
    if (!partial) {
      expect(partial.error().code == ce::v1::errc::missing_required_attribute);
  ...
  "get reports the first failure and does not report a later one"_test = [] {
    ce::v1::event subject = minimal();
    auto read = subject.get<ce::v1::ext::partitioning>();
    expect(!read.has_value());
    if (!read) {
...
void check_json_type_recovery(std::string_view label) {
  ...
  ce::v1::event subject = minimal();
  const ce::v1::ext::tracing tracing{.traceparent = "00-0af7651916cd43dd-b7ad6b7169203331-01",
                                 .tracestate = "congo=t61rcWkgMzE"};
  expect(subject.set(tracing).has_value()) << label;
  expect(subject.set(ce::v1::ext::sampled_rate{.sampledrate = 30}).has_value()) << label;
  expect(subject.set(ce::v1::ext::dataref{.value = ce::v1::uri_ref{"https://example.test/b"}}).has_value())
      << label;
  ...
  auto read_tracing = decoded->template get<ce::v1::ext::tracing>();
  ...
  auto read_rate = decoded->template get<ce::v1::ext::sampled_rate>();
  ...
  auto read_ref = decoded->template get<ce::v1::ext::dataref>();
...
void check_http_type_recovery(std::string_view label) {
  ...
  auto message = ce::v1::http::to_message<C>(subject, ce::v1::content_mode::binary_mode);
  expect(message.has_value()) << label;
  if (!message) {
    return;
  }
  auto decoded = ce::v1::http::from_message<C>(*message);
  expect(decoded.has_value()) << label;
  if (!decoded) {
    return;
  }
...
void check_recovery_failures(std::string_view label) {
  ...
  const auto reject = [&label](std::string_view stored, auto probe) {
    ce::v1::event subject = minimal();
    expect(subject.set_extension(std::string{probe.name}, ce::v1::attribute_value{std::string{stored}})
               .has_value())
        << label;
    auto read = probe.read(subject);
    expect(!read.has_value()) << label << ": should reject " << stored;
    if (!read) {
      expect(read.error().code == ce::v1::errc::type_mismatch) << label << ": " << stored;
  ...
  struct rate_probe {
    ...
    static auto read(const ce::v1::event& e) { return e.get<ce::v1::ext::sampled_rate>(); }
  };
  ...
  ce::v1::event subject = minimal();
  expect(subject.set_extension("sampledrate", ce::v1::attribute_value{std::string{"30"}}).has_value())
      << label;
  auto read = subject.get<ce::v1::ext::sampled_rate>();
  ...
  ce::v1::event odd = minimal();
  expect(odd.set_extension("sampledrate", ce::v1::attribute_value{true}).has_value()) << label;
  auto mismatched = odd.get<ce::v1::ext::sampled_rate>();
  expect(!mismatched.has_value()) << label;
  if (!mismatched) {
    expect(mismatched.error().code == ce::v1::errc::type_mismatch) << label;
  }
}
...
void check_event_of(std::string_view label) {
  using namespace boost::ut;
  using view = ce::v1::event_of<payload, C>;
